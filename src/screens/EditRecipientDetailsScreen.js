...
const EditRecipientDetailsScreen = ({navigation, route}) => {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.heading1}>Edit Recipient Details</Text>
      </View>
...
export default EditRecipientDetailsScreen;
...
const styles = StyleSheet.create({
  ...
  //-------------------- Edit Recipient Details Screen Body --------------------//
  bodyContainer: {
    marginVertical: 50,
    marginHorizontal: 10,
    padding: 20,
